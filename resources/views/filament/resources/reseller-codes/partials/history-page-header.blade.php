...
<header class="fi-header fi-header-has-breadcrumbs">
    <div>
        ...
        <h1 class="fi-header-heading" style="display:inline-flex;align-items:center;gap:0.625rem;flex-wrap:wrap;">
            ...
            <span class="sl-rch-pill {{ $isActive ? 'sl-rch-pill--active' : 'sl-rch-pill--inactive' }}" style="display:inline-flex;align-items:center;border-radius:0.375rem;padding:0.15rem 0.55rem;font-size:0.75rem;font-weight:600;line-height:1.25;letter-spacing:0.01em;
                @if ($isActive)
